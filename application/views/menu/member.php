<div style="position:absolute;right:250px;top:20px;">
	...
	<p id = "show_opt" style="font-size:15px;font-family:museo-sans-rounded, sans-serif;color:white;text-decoration:none;cursor:pointer;float:right;margin-left:5px;margin-top:4px;"><?php echo "$username $level";?></p>
